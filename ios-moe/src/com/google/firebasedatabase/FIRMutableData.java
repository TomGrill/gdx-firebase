...
public class FIRMutableData extends NSObject {
	...
	@Generated
	protected FIRMutableData(Pointer peer) {
		super(peer);
	}
	...
	@Owned
	@Selector("alloc")
	public static native FIRMutableData alloc();
	...
	@Generated
	@Selector("childDataByAppendingPath:")
	public native FIRMutableData childDataByAppendingPath(String path);
	...
	@Generated
	@Selector("hasChildAtPath:")
	public native boolean hasChildAtPath(String path);
	...
	@Generated
	@Selector("init")
	public native FIRMutableData init();
	...
	public native void setPriority(@Mapped(ObjCObjectMapper.class) Object value);
