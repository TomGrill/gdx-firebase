...
public class AndroidDataSnapshot implements DataSnapshot {
    ...
    public AndroidDataSnapshot(com.google.firebase.database.DataSnapshot dataSnapshot) {
        this.dataSnapshot = dataSnapshot;
    }

    @Override
    public DataSnapshot child(String path) {
        return new AndroidDataSnapshot(dataSnapshot.child(path));
    }
    ...
    public Iterable<DataSnapshot> getChildren() {
        ...
        for (com.google.firebase.database.DataSnapshot dataSnapshot : this.dataSnapshot.getChildren()) {
            resultIterable.add(new AndroidDataSnapshot(dataSnapshot));
        }
